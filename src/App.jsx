...
export default function App() {
  ...
  /* THE GATE. Nobody signed in means the front page — the Field
     Cartography design with the sign-in card folded into it — and nothing
     else: no sidebar, no top bar, no data pages mounted behind it. */
